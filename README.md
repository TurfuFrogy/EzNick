...
<h3 align="center">EzNick</h3>

<p align="center">The Fastest Minecraft Username Checker</p>
...
- Advanced error handling with automatic retry management in case of ratelimit
- Easy Setup / Clean and Noob-Friendly UI

## Previews
[Image](https://i.imgur.com/tbcMogO.png)

## FAQ
- **Q: How to use EzNick?**
- A: You must first download the requirements with the command `pip install -r requirements.txt` and then follow the instructions after starting EzNick with the command `python main.py`. You can also run the downloadable executable directly from the [Releases](https://github.com/TurfuFrogy/EzNick/releases).
